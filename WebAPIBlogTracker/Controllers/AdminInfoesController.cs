...
using WebAPIBlogTracker.Models;

namespace WebAPIBlogTracker.Controllers
{
    ...
    public class AdminInfoesController : ControllerBase
    {
        ...
        public AdminInfoesController(capstoneprojectContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<AdminInfo>> PostAdminInfo(AdminInfo adminInfo)
        {
          if (_context.AdminInfos == null)
          {
              return Problem("Entity set 'capstoneprojectContext.AdminInfos'  is null.");
          }
